...
class StreamPay_Currencies {

    public function add_currencies($currencies) {
        $supported_currencies = StreamPay_Currencies_Helper::get_supported_currencies();
    ...
    public function change_currency_position($format, $currency_pos) {
        if($this->is_streampay_supported_currency()) {
    ...
    public function adjust_currency_decimals($decimals) {
        if($supported_currency = $this->is_streampay_supported_currency()) {
    ...
    public function is_streampay_supported_currency() {
